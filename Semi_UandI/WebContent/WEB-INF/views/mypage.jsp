...
<body>
  ...
  <div class = "container">
    <div class="scroll-moveBox flex flex-br-c">
      <ul class = "list-group list-group-horizontal-lg">
        <li class="list-group-item"><a href="#div1" id="scroll_move">ê°ì¸ì ë³´</a></li>
        <li class="list-group-item"><a href="#div2" id="scroll_move">ì¤íì¼ì ë³´</a></li>
        <li class="list-group-item"><a href="#div3" id="scroll_move">ìª½ì§</a></li>
      </ul>
    </div>
    <hr/>
    <div id="div1" style="height: 400px;">ê°ì¸ì ë³´<hr/>
      <div id = "main-content">
        <div id = "join_box">
          <form name = "member_form">
             <!-- ê° ì¤ë§ë¤ ë¼ë²¨, ì¸íìì ìì­ì¼ë¡ ëëì´ ì§ë¯ë¡ col1, col2 í´ëì¤ì§ì ì¼ë¡ ì¤íì¼ë§ -->
            <div class="form id">
              <div class="col1">ìì´ë</div>
              <div class="col2"><input type = "text" value = ""/></div>
            </div>
            <div class="form">
              <div class="col1">ë¹ë°ë²í¸</div>
              <div class="col2"><input type="password" name="pass" value=""></div>
            </div>
            <div class="clear"></div>
            <div class="form">
              <div class="col1">ë¹ë°ë²í¸ íì¸</div>
          ...
          <div class = "buttons" style = "float: right;">
            <input class = "btn btn-outline-primary" type = "submit" value = "ìì íê¸°" onclick="submitForm()"/>
            <input class = "btn btn-outline-primary" type = "button" value = "ì´ê¸°í" onclick="resetForm()"/>
          </div>
          </form>
        </div>
      </div>
    ...
    <hr/>
    <div id="div2" style="height: 300px;">ì¤íì¼ì ë³´<hr/>
      <div>
    ...
    <hr/>
    <div id="div3" style="height: 300px;">ìª½ì§<hr/>
      <div>
  ...
  <script>
    ...
    functionÂ fnMove(seq){
      varÂ offsetÂ =Â $("#div"Â +Â seq).offset();
      $('html,Â body').animate({scrollTopÂ :Â offset.top},Â 400);
    }
    ...
    function submitForm(){
      ...
      // ìë ¥ê° ì¤ì ë¹ì´ìì¼ë©´ ìëë ê²ë¤ì´ ìì.

      // idì¹¸ì´ ë¹ì´ ìëê°?
      if(!document.member_form.id.value){
          alert("ìì´ëë¥¼ ìë ¥íì¸ì.");
          //ì»¤ì(í¬ì»¤ì¤)ë¥¼ ìì´ë ì¸íììë¡ ì´ë
          document.member_form.id.focus();
          //ìëì submit()ì íë©´ ìëë¯ë¡...
          return;
      }
      // ë¹ë°ë²í¸ ë¹ì´ ìëê°?
      if(!document.member_form.pass.value){
          alert("ë¹ë°ë²í¸ë¥¼ ìë ¥íì¸ì.");
          document.member_form.pass.focus();
          return;
      }
       // ë¹ë°ë²í¸ íì¸ ë¹ì´ ìëê°?
       if(!document.member_form.pass_confirm.value){
          alert("ë¹ë°ë²í¸ íì¸ì ìë ¥íì¸ì.");
      ...
      // ë¹ë°ë²í¸ì ë¹ë°ë²í¸ íì¸ ì¹¸ì ìë ¥ê°ì´ ê°ìì§ ë¹êµ
      if(document.member_form.pass.value != document.member_form.pass_confirm.value){
          alert("ë¹ë°ë²í¸ê° ì¼ì¹íì§ ììµëë¤.\në¤ì ìë ¥í´ ì£¼ì¸ì.");
          document.member_form.pass.focus();
          // ì»¤ìê° ì´ëíê³  ê·¸ê³³ì ì¨ìë ê¸ì¨ê° ì íëì´ ìì.
          document.member_form.pass.select();
          return;
      }

      // formììë¥¼ ì§ì  submitíë ë©ìë
      document.member_form.submit(); //ê² ìë¦¬ë¨¼í¸ ìíê³  í¼, ì¸íì nameìì±ì´ document ë°°ì´ë¡ ì°¾ì ì ìì.
    }
