  ...
  <div class = "container">
    <div id="wrap">
      <div class="login_form">
        <div id="alert_text">
          <p>ë¹ë°ë²í¸ë¥¼ ì¬ìë ¥í´ì£¼ì­ìì¤.</p>
          <br/>
        </div>
        <div>
          <input type = "password" class = "form-control" name = "mb_pwd" id = "mb_pwd" placeholder="ë¹ë°ë²í¸"/>
        </div>
        <br/>
        <div class="d-grid gap-2" >
          <button class = "btn btn-primary btn-lg" id = "login" type = "button" onclick="loginCheck()">ë¡ê·¸ì¸</button>
        </div>
      </div>
    </div>
  </div>
